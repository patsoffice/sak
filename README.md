...
- `sak linux cpuinfo|meminfo|mounts|loadavg|uptime` instead of `awk`-ing `/proc/cpuinfo`, `/proc/meminfo`, the mount table, `/proc/loadavg`, or `/proc/uptime` (Linux-only; more `/proc` parsers arrive in follow-ups)
