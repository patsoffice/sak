...
- `sak linux cpuinfo|meminfo|mounts|loadavg` instead of `awk`-ing `/proc/cpuinfo`, `/proc/meminfo`, the mount table, or `/proc/loadavg` (Linux-only; more `/proc` parsers arrive in follow-ups)
